...
@Slf4j
@Component
public class ActivateUserServiceTask implements JavaDelegate {

    private final KeycloakService keycloakService;

    @Autowired
    public ActivateUserServiceTask(KeycloakService keycloakService) {
    ...
    public void execute(DelegateExecution delegateExecution) throws Exception {
        ...
        keycloakService.activateUser(userId);
        log.debug("User {} was activated!", userId);
    }
}
